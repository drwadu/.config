...
vim.keymap.set('n', '<leader>x', ':Sex<CR>')
vim.keymap.set('n', '<leader>q', ':quit<CR>')
vim.keymap.set('n', '<leader>ee', ':Ex<CR>')
vim.keymap.set({ 'n', 'v' }, '<leader>n', ':norm ')
vim.keymap.set('n', '<leader>csd', ':colorscheme no-clown-fiesta-dark<CR>')
vim.keymap.set('n', '<leader>csm', ':colorscheme no-clown-fiesta-dim<CR>')
vim.keymap.set('n', '<leader>csl', ':colorscheme no-clown-fiesta-light<CR>')
